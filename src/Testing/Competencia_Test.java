...
public class Competencia_Test {
    ...
    public static void main(String[] args) {
        ...
        //Partidas Juan
        Partida partidaJ1 = new Partida("2023_11_26", 3600, 84, fortnite);
        Partida partidaJ2 = new Partida("2023_1_6", 2000, 100, fortnite);
        Partida partidaJ3 = new Partida("2023_12_2", 3600, 10, ajedrez);
        Partida partidaJ4 = new Partida("2023_6_16", 700, 85, tetris);
        Partida partidaJ5 = new Partida("2023_3_4", 1600, 76, fortnite);
        ...
        Partida partidaP8 = new Partida("2023_8_15", 2910, 65, tetris);
        Partida partidaP9 = new Partida("2023_5_12", 1783, 15, apexLegends);
        Partida partidaP10 = new Partida("2023_10_1", 4215, 0, ajedrez);

        //Partidas Alice
        Partida partidaA1 = new Partida("2023_9_10", 2483, 42, apexLegends);
        Partida partidaA2 = new Partida("2023_7_3", 3210, 30, tetris);
        Partida partidaA3 = new Partida("2023_4_22", 1935, 51, fortnite);
        Partida partidaA4 = new Partida("2023_2_8", 3892, 10, ajedrez);
        Partida partidaA5 = new Partida("2023_11_30", 2765, 13, apexLegends);
        Partida partidaA6 = new Partida("2023_6_5", 1428, 15, tetris);
        Partida partidaA7 = new Partida("2023_3_18", 3074, 46, fortnite);
        Partida partidaA8 = new Partida("2023_1_1", 1987, 5, ajedrez);

        //Partidas Bob
        Partida partidaB1 = new Partida("2023_7_14", 2679, 38, fortnite);
        Partida partidaB2 = new Partida("2023_4_9", 1942, 22, tetris);
        Partida partidaB3 = new Partida("2023_10_5", 3367, 89, apexLegends);
        Partida partidaB4 = new Partida("2023_2_20", 1598, 5, ajedrez);
